...
class LTX2DecodeKeyframes:
    ...
    def for_frame_span(self, frame_lo: int, frame_hi: int) -> LTX2DecodeKeyframes:
    ...
    def crop_spatial(self, height: slice, width: slice) -> LTX2DecodeKeyframes:
