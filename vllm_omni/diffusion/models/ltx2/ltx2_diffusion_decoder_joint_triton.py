...
# SPDX-FileCopyrightText: Copyright 2026 Lightricks. All rights reserved.
#
# Copied and modified from LTX-Video commit a95ab85 (Apache-2.0).

# ruff: noqa: ANN001, ANN202, PLR0913
"""Triton joint (video + keyframe) 3D neighborhood attention.
Matches the pinned official LTX implementation at commit
``a95ab856bf29407b6b066ede0abe1846050db56c``. It is flash-style: one program owns
``BLOCK_Q`` queries along W at a
...
def joint_na3d(
    ...
    Signature-compatible with the pinned official joint attention implementation.
    Args:
